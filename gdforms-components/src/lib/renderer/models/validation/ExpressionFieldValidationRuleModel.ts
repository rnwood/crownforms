...
export interface IExpressionFieldValidationRuleModelOptions extends IFieldValidationRuleModelOptions {
  readonly type: "expression",
  expression: string,
  errorMessage?: string|undefined;
}

export class ExpressionFieldValidationRuleModel extends FieldValidationRuleModel<IExpressionFieldValidationRuleModelOptions> {
  ...
  validate(
    ...
    const error = this.options.errorMessage ?? this.getDefaultErrorMessage(field);
